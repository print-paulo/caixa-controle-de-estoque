...
if __name__ == "__main__":
    ...
    edit.editar_nome_produto(id_produto, input("Novo nome do produto: "))
    
    edit.editar_categoria(id_produto, input("Nova categoria: "))
    
    edit.editar_codigo_barras(id_produto, input("Novo código de barras: "))
    
    nova_quantidade = input("Nova quantidade: ")
    nova_quantidade = None if nova_quantidade == "" else int(nova_quantidade)
