...
from services.buscar_produto import buscar_por_id, buscar_nome_por_id, buscar_codigo_barras_por_id, buscar_categoria_por_id, buscar_medida_quantidade_por_id, buscar_unidade_por_id, buscar_valor_unitario_por_id, buscar_estoque_deposito_por_id, buscar_estoque_exposicao_por_id, buscar_capacidade_exposicao_por_id, buscar_estoque_minimo_por_id
